  ...
  return (
    <div className={classes.cart}>
      <div className={classes.order}>
        ...
        {props.items.map(item=>{
          return <div className={classes.eachItem}>
            ...
            <div style={{display:"flex",flexDirection:"column",justifyContent:"space-between",width:"100%"}}>
              ...
              <div>
              <p><span style={{textDecoration:"line-through"}}>&#8377;{item.crossedPrice}</span> <span style={{marginLeft:"10px"}}>&#8377;{item.price}</span></p>
      ...
      <div className={classes.payment}>
        ...
        <p>Log In to use use account-linked coupons</p>
        <hr style={{border:"1px dotted black"}}></hr>
        <p style={{fontWeight:"600",color:"rgb(3, 166, 133)"}}>Price Details</p>
        <div className={classes.price}>
            ...
            <div>
              <p>&#8377;{crossedTotal}</p>
              <p>- &#8377;{totalDiscount}</p>
              <p style={{color:"#ff3f6c",cursor:"pointer"}}>Apply Coupons</p>
              <p>&#8377;{total}</p>
              <p>FREE</p>
            </div>
         </div>
